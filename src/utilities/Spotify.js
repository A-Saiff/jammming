...
const getAuthAccessToken = () => {
  ...
  if (!access_token || expires_in < Date.now()) {
    if (window.location.hash.includes("access_token")) {
      ...
      window.location =
        "https://accounts.spotify.com/authorize?client_id=1e7ef874eb474e4498ffff2c49f57c07&response_type=code&redirect_uri=https://jammwithspotify.netlify.app/&scope=playlist-modify-public";
    }
  }
